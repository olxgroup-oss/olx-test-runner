...
This is because your tests are not isolated and they are interfering each other. Please use
`validate` command to see how you can resolve it.

Additionally, make sure that your singleton classes are being reset before each group.

You can also try running interference detection command to see which tests are interfering each
other.